...
<body>
                    ...
                    <div class="main white-bg">
                        <nav class="navbar navbar-expand navbar-light navbar-bg">
                            ...
                            <div class="navbar-collapse collapse">
                                <ul class="navbar-nav navbar-align">
                                    <li class="nav-item">
                                        <!--   <a class="nav-icon notification d-inline-block" href="client-notification.html">
                        ...
                        <main class="content">
                            <div class="container-fluid analytics-page mt-4">
                                ...
                                <form method='post' action="{{route('analytics.search')}}">
                                    @csrf
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col">
                                            ...
                                            <!--                                             <select class="custom-select mr-sm-2 zsm_select" id="inlineFormCustomSelect"-->
                                        ...
                                        @endif
                                        @if($user_type =='zsm'||'ho'||'bdm')

                                        <div class="col">
                                            <label for="inlineFormCustomSelect">Field Force (PS) </label><br>
                                            <span id="error-ff_select" style="color:red;"></span>
                                        ...
                                        <div class="col">
                                            ...
                                            <select class="custom-select mr-sm-2 brand_select" id="brand_select">
                                        ...
                                        <div class="col">
                                            <button type="button" class="btn btn-dark" id="filter">
                                                Filter
                                ...
                                <div class="row quick-summary mt-5">
                                    <div class="qs-head">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h5 class="mb-4">Quick summary of current financial year ({{$start_date}} to {{$end_date}})
                                                </h5>
                                            </div>
                                            <div class="col-md-6 text-right">
                                                <p>
                                                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M12.5 0C15.8152 0 18.9946 1.31696 21.3388 3.66117C23.683 6.00537 25 9.18479 25 12.5C25 15.8152 23.683 18.9946 21.3388 21.3388C18.9946 23.683 15.8152 25 12.5 25C9.18479 25 6.00537 23.683 3.66116 21.3388C1.31696 18.9946 0 15.8152 0 12.5C0 9.18479 1.31696 6.00537 3.66116 3.66117C6.00537 1.31696 9.18479 0 12.5 0ZM14.3749 7.67445C15.3034 7.67445 16.0569 7.02985 16.0569 6.07457C16.0569 5.11928 15.3016 4.47468 14.3749 4.47468C13.4464 4.47468 12.6964 5.11928 12.6964 6.07457C12.6964 7.02985 13.4464 7.67445 14.3749 7.67445ZM14.7016 17.7219C14.7016 17.5309 14.7677 17.0345 14.7302 16.7524L13.2624 18.4415C12.9589 18.7612 12.5786 18.9826 12.4 18.9236C12.319 18.8938 12.2513 18.8361 12.2091 18.7608C12.1668 18.6855 12.1529 18.5976 12.1697 18.513L14.6159 10.7849C14.8159 9.80466 14.2659 8.91008 13.1 8.7958C11.8697 8.7958 10.0591 10.0439 8.9574 11.6277C8.9574 11.817 8.92168 12.2884 8.95918 12.5705L10.4251 10.8796C10.7287 10.5635 11.0822 10.3403 11.2608 10.401C11.3488 10.4326 11.4209 10.4974 11.4616 10.5816C11.5023 10.6657 11.5084 10.7624 11.4786 10.851L9.05382 18.5415C8.77348 19.4415 9.3038 20.3235 10.5894 20.5235C12.4821 20.5235 13.5999 19.3058 14.7034 17.7219H14.7016Z" fill="#FF5D2C" />
                                                    </svg>
                                                    Quick view result is based on current financial year in overall india, no
                                                    filter applied.
                                                </p>
                                    ...
                                    <div class="col align-items-center">
                                        <div class="qs-card clr1 align-items-center">
                                            ...
                                            <div class="qs-card-text">
                                                <h4>Number of<br>
                                                    Patients on going</h4>
                                            </div>
                                            <div class="qs-card-count">
                                                <h1><span id="patients_ongoing_count">{{$patients_ongoing_count}}</span></h1>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col align-items-center">
                                        <div class="qs-card clr2">
                                            ...
                                            <div class="qs-card-text">
                                                <h4>Number of<br>
                                                    Patients on dropout</h4>
                                            </div>
                                            <div class="qs-card-count">
                                                <h1><span id="patient_dropout_count">{{$patient_dropout_count}}</span></h1>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col align-items-center">
                                        <div class="qs-card clr3">
                                            ...
                                            <div class="qs-card-count">
                                                <h1><span id="total_rxCount">{{$total_rxCount}}</span></h1>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col align-items-center">
                                        <div class="qs-card clr4">
                                            ...
                                            <div class="qs-card-count">
                                                <h1><span id="dose_scheduled">{{$dose_scheduled}}</span></h1>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col align-items-center">
                                        <div class="qs-card clr4">
                                            ...
                                            <div class="qs-card-count">
                                                <h1><span id="avg_cycle_count">{{$avg_cycle_count}}</span></h1>
                                            </div>
                                        </div>
                                    </div>
                                </div>

                                <div class="detailed-report mt-5 mb-5">
                                    <h5>Detailed Report</h5>
                                    <div class="row mt-4">
                                        <div class="col-md-3">
                                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                <a class="nav-link active" id="analytics-one-tab" data-toggle="pill" href="#analytics-one" role="tab" aria-controls="analytics-one" aria-selected="true">Patient Analysis</a>
                                                <a class="nav-link" id="analytics-two-tab" data-toggle="pill" href="#analytics-two" role="tab" aria-controls="analytics-two" aria-selected="false">Prescriber Analysis</a>
                                                <a class="nav-link" id="analytics-three-tab" data-toggle="pill" href="#analytics-three" role="tab" aria-controls="analytics-three" aria-selected="false">Ex Entry Analysis</a>
                                                <a class="nav-link" id="analytics-four-tab" data-toggle="pill" href="#analytics-four" role="tab" aria-controls="analytics-four" aria-selected="false">Indication wise Analysis</a>
                                                <a class="nav-link" id="analytics-five-tab" data-toggle="pill" href="#analytics-five" role="tab" aria-controls="analytics-five" aria-selected="false">Cycles Analysis</a>
                                            </div>

                                        </div>
                                        <div class="col-md-9">
                                            <div class="tab-content" id="v-pills-tabContent">
                                                <div class="tab-pane fade show active" id="analytics-one" role="tabpanel" aria-labelledby="analytics-one-tab">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="card">
                                                                <div class="card-header">
                                                                    <div class="row justify-content-between">
                                                                        <div class="col-md-8">
                                                                            <h5>No. of patients ongoing and no of
                                                                                patients drop
                                                                                out</h5>
                                                                        </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="card">
                                                                <div class="card-header">
                                                                    <div class="row justify-content-between">
                                                                        <div class="col-md-6">
                                                                            <h5>Patient drop out trend</h5>
                                                                        </div>
                                                                        <div class="col-md-4 text-right">
                                                                            <button type="button" class="btn btn-warnin-outline" id="dropout_trend">Export
                                                                                Excel</button>
                                                                        </div>
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="chart chart-sm">
                                                                        <canvas id="chartjs-dashboard-line-patient-week"></canvas>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="card">
                                                                <div class="card-header">
                                                                    <div class="row justify-content-between">
                                                                        <div class="col-md-6">
                                                                            <h5>New Patient recruitment trent</h5>
                                                                        </div>
                                                                        <div class="col-md-4 text-right">
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="chart chart-sm">
                                                                        <canvas id="chartjs-dashboard-line-recruitment-week"></canvas>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="tab-pane fade" id="analytics-two" role="tabpanel" aria-labelledby="analytics-two-tab">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="card">
                                                                <div class="card-header">
                                                ...
                                                <div class="tab-pane fade" id="analytics-three" role="tabpanel" aria-labelledby="analytics-three-tab">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="card">
                                                                <div class="card-header">
                                                ...
                                                <div class="tab-pane fade" id="analytics-four" role="tabpanel" aria-labelledby="analytics-four-tab">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="card">
                                                                <div class="card-header">
                                                ...
                                                <div class="tab-pane fade" id="analytics-five" role="tabpanel" aria-labelledby="analytics-five-tab">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="card">
                                                                <div class="card-header">
                                                                    <div class="row justify-content-between">
                                                                        <div class="col-md-8">
                                                                            <h5>Average number of cycles purchased</h5>
                                                                        </div>
                                                                        <div class="col-md-4 text-right">
                                                                            <!-- <button type="button" class="btn btn-warnin-outline">Export
                                                                                Excel</button> -->
    ...
    <script>
        ...
        $('.team_select').on('change', function(e) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    option1 = "<option value=''>Choose ZSM</option>";
                    $.each(data.user_list, function(index, value) {
                        option1 = option1 + "<option value=" + value['user_id'] + ">" + value['first_name'] + ' ' + value['last_name'] + "</option>";
                    });
                    $(".zsm_select").html(option1);
                },
        ...
        $(".zsm_select").change(function() { //alert("pp");return false;
            $.ajax({
                type: "get",
                url: '/user_selected_details',
                async: true,
        ...
        $(".bdm_select").change(function() {
            $.ajax({
                ...
                success: function(response) {
                    var data = response.data;
                    //console.log(data.zsm_list);return false;
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(data.brand_list, function(index, value) {
                        option1 = option1 + "<option value=" + value['brand_id'] + ">" + value['brand_name'] + "</option>";
                    });
        ...
        //excel for prescriber monthwise count 
        ...
        $('#filter').on('click', function(e) {
            ...
            if (user_type == 'ho') {
                if (team_select == '') {
                    $('#error-team_select').text('Team required');
                    $("#team_select").focus();
                    flag = false;
                }
                if (zsm_select == "") {
                    $('#error-zsm_select').text('ZSM required');
                    $("#zsm_select").focus();
                    flag = false;
                }
            }
            if ((user_type == 'zsm') || (user_type == 'ho')) {
                if (bdm_select == '') {
                    $('#error-bdm_select').text('BDM required');
                    $("#bdm_select").focus();
                    flag = false;
                }
            }
            if (ff_select == "") {
                $('#error-ff_select').text('FF required');
                $("#ff_select").focus();
                flag = false;
            }
            if (brand_select == "") {
                $('#error-brand_select').text('Brand required');
                $("#brand_select").focus();
                flag = false;
            }
            if (start_date == '') {
                $('#error-start_date').text('StartDate required');
                $("#start_date").focus();
                flag = false;
            }
            if (end_date == "") {
                $('#error-end_date').text('EndDate required');
                $("#end_date").focus();
                flag = false;
            }
            if (flag == false) {
            ...
            graphLoad(user_type, user_id, brand_select, start_date, end_date, ff_select);
        });
    </script>
    <script>
        $(function() {
    ...
    <script>
        function quickView(user_type, user_id, brand_select, start_date = '', end_date = '', ff_select = '') {
            $.ajax({
                type: "get",
                url: '/quick_summary',
                async: true,
        ...
        function graphLoad(user_type, user_id, brand_select, start_date = '', end_date = '', ff_select = '') {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    new Chart(document.getElementById("chartjs-dashboard-line-recruitment-week"), {
                        type: "line",
                        data: {
                            labels: weeks,
                            datasets: [{
            ...
            var ctx = document.getElementById("chartjs-dashboard-line-recruitment-week").getContext("2d");
            ...
            $.ajax({
                ...
                success: function(response) { //console.log("patient dropout trend");console.log(response);return false;
                    data = JSON.parse(response.data);
                    var weeks = [];
                    var counts = [];
                    $.each(data, function(index, val) {
                    ...
                    new Chart(document.getElementById("chartjs-dashboard-line-patient-week"), {
                        type: "line",
                        data: {
                            labels: weeks,
                            datasets: [{
            ...
            $.ajax({
                ...
                success: function(response) {
                    console.log('reasons');
                    console.log(response);
                    patient_data = JSON.parse(response.data);
                    datanew = [];
                    newdata = [];
                    angle = [];
                    $.each(patient_data, function(index, val) {
                        datanew = {
                            label: val['reason'],
                            y: val['total']
                        }
            ...
            $.ajax({
                ...
                success: function(response) {
                    console.log("ongoing and dropout");
                    patient_ongoing = JSON.parse(response.data['patient_ongoing']);
                    datanew = [];
                    newdata = [];
                    $.each(patient_ongoing, function(index, val) {
                        datanew = {
                            label: index,
                            y: val
                        }
                    ...
                    patient_dropout = JSON.parse(response.data['patient_dropout']); //console.log(patient_dropout);return false;
                    datanew1 = [];
                    newdata1 = [];
                    $.each(patient_dropout, function(index1, val1) {
                        datanew1 = {
                            label: index1,
                            y: val1
                        }
                        newdata1.push(datanew1);
                    });
                    console.log(newdata);
            ...
            $.ajax({
                ...
                success: function(response) {
                    console.log("prescriber_rx_analysis"); //return false;
                    data = JSON.parse(response); //console.log(data);

                    datanew1 = [];
                    newdata1 = [];
                    // $.each(data , function(index1, val1) {
                    //     datanew = {  label : index1,
                    //       y : val1}
                    //       newdata.push(datanew);
                    //       });console.log(newdata);
                    $.each(data, function(index, val) {
                        ...
                        datanew = [];
                        newdata = [];
                        $.each(val, function(index1, val1) { //console.log(index);return false;
            ...
            $.ajax({
                ...
                success: function(response) {
                    console.log("prescriber_count");
                    prescriber_count = JSON.parse(response.data);
                    datanew = [];
                    newdata = [];

                    $.each(prescriber_count, function(index, val) {
                        datanew = {
                            label: index,
                            y: val
                        }
                        newdata.push(datanew);
                    }); //console.log(newdata);return false;
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    //  console.log(newdata1);return false;
                    var chart2 = new CanvasJS.Chart("LinechartContainer", {
                        animationEnabled: true,
                        exportEnabled: true,

                        axisY: {
                            title: "Rx Entries + Cycle"
                        },
                        toolTip: {
                            shared: true
                        },
            ...
            $.ajax({
                ...
                success: function(response) {
                    console.log('rx split btw institution type');
                    console.log(response);
                    data_government = JSON.parse(response.data['data_government']);
                    datanew = [];
                    newdata = [];
                    $.each(data_government, function(index, val) { //console.log(index);console.log(val);return false;
                        datanew = {
                    ...
                    data_corperate = JSON.parse(response.data['data_corperate']); //console.log(patient_dropout);return false;
                    datanew1 = [];
                    newdata1 = [];
                    $.each(data_corperate, function(index1, val1) {
                        datanew1 = {
                            label: index1,
                            y: val1
                        }
                    ...
                    data_trade = JSON.parse(response.data['data_trade']);
                    datanew2 = [];
                    newdata2 = [];
                    $.each(data_trade, function(index2, val2) {
                        datanew2 = {
                            label: index2,
                            y: val2
                        }
                        newdata2.push(datanew2);
                    });
            ...
            $.ajax({
                ...
                success: function(response) {
                    console.log('rx split btw patient type'); //console.log(response);return false;
                    data = JSON.parse(response);
    ...
    <!-- var chart4 = new CanvasJS.Chart("multiBarchartContainer", {
        ...
        function toolTipContent(e) {
            ...
            for (var i = 0; i < e.entries.length; i++) {
                var str1 = "<span style= \"color:" + e.entries[i].dataSeries.color + "\"> " + e.entries[i].dataSeries
    ...
    <script>
        var chart9 = new CanvasJS.Chart("sharpLinechartContainerThree", {
            ...
            data: [{
                ...
                },
                {
                    ...
                    dataPoints: [{
                        ...
                        {
                            x: new Date(2017, 00, 16),
                            y: 28.7
                        },
                        {
                            x: new Date(2017, 00, 18),
                            y: 22.5
                        },
                        {
                            x: new Date(2017, 01, 4),
