    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mt-4">
                <div class="col-md-4">
                    <div class="update-pp">
                        <!-- src="{{ asset('images/edit-pp.png') }}" -->
                        <label for="upload"><img @if($user->profile_pic==null)) src="{{ asset('images/edit-pp.png') }}"@else src="{{ asset('images/profile_pc/'.$user->profile_pic)}}" @endif >
                        </label>
                ...
                <div class="col-md-4 profile-datails">
                    ...
                    <div class="bb-profile mt-5">
                        <form class="bb-form validate-form">
                            ...
                            <div class="wrap-input100 validate-input">
                                <input class="input100" type="text" name="location" value="{{ $user->address }}" readonly>
                ...
                <!-- <div class="profile-btns">
                    <a href="{{ url('/profile/'. encrypt($user->id).'/edit') }}"> <button type="button" class="btn btn-warning">EDIT PROFILE</button></a>
                </div> -->
            </div>
        </div>
    </div>
